+++
title = "the practice of chinese learning dump"
authors = ["Douglas"]
date = 2024-08-01
[taxonomies]
[extra]
...
My interest in Chinese culture goes way back to my childhood. The symbols (ideograms), martial arts and overall cultural aspects instilled in me a fascination of it's own kind. Now, heading into this journey.
...
* **General resources**
    ...
    - [Chinese Cinema](https://disk.yandex.com/d/YEg7gd2TcBOHbQ) A fried of mine is addicted to Cinema and made this list of classical Chinese movies, from famous directors! Even if you're not that much in Chinese learning, check it out! Password is: ```Ch3nKaiRulz```. If you want to download it all, get [this torrent](https://drive.google.com/file/d/1hfnpu2mGB5lgZFL30JJqwJSV063CE64y/view?usp=share_link). Movies included:
* **Movies:**
...
* **Chinese Cinema History**:
	...
	- [CN folder on Cloud](https://disk.yandex.com/d/p6kAhae4odR0Eg)
	  I hosted for many years a lot of resources for language learning on my cloud disk drive and you can still access it from the link above. It's a couple of Gigabytes in size (~20GB) for the mandarin resources (```lang/cn/```) and they came from a publicly available torrent at that time (2018) as well as many other languages in there.
----
* **Community resources**
