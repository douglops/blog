+++
title = "using multiple github accounts locally"
authors = ["Douglas"]
date = 2022-11-10
[taxonomies]
...
> Of course, you can use [this](https://docs.github.com/en/account-and-profile/how-tos/account-management/managing-multiple-accounts), but... why not!?
...
- Install your GPG suite of tools.
  _ Windows: [Gpg4win](https://www.gpg4win.org/)
  _ MacOS: [GPG Suite](https://gpgtools.org/) integrates automagically in the MacOs keychain. Check be above documentation for nitty-gritty details. \* Unix/Linux: Chances are you already have it, but give [gpg-agent](http://linux.die.net/man/1/gpg-agent) a try
...
> It _must_ be at least 4096 bits (default option)
...
The above image says that in some cases, you want to use your personal username to work for your org, but using the _org_ domain email, while, for your private projects, preserving the personal username + email address, also. But... is that possible? _Yes_, my horseshoe crab!
...
Now, for cloning accordingly (Github example), for other configured accounts _not_ in your first `[Include]`- which is applicable to any folder _besides_ the configured others - you need to run the clone command this way:
